...
**Verification:** full backend suite **978 passed / 0 failed** (6 live tests skipped). Every prompt change verified by rendering; the region engine has a byte-identical-when-ON regression test + the offline preview tool.
