...
TOOLS = [
    ...
    ("getAvailableAppointments", "/get-available-slots",
     ...
     [{"name": "days", "type": "number", "description": "Days ahead default 7 max 14"},
      ...
      {"name": "preferredTime", "type": "string", "description": "Preferred time of day"},
      {"name": "category", "type": "string", "description": "Appointment type if configured (drives duration)"},
      {"name": "topic", "type": "string", "description": "Caller concern/domain in 2-4 words, for routing to the right employee"}], 15),
