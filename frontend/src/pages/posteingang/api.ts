...
> = {
  ...
  kva_suggested: { type: 'kva', accent: 'var(--ai)', label: 'Angebot', variant: 'ai', title: () => 'Angebots-Entwurf', primary: 'Angebot einsehen', secondary: null, tertiary: null, reco: (_n, c) => `Im Anruf erwähnt — Angebot für ${c} prüfen und ggf. erstellen`, assignable: false, notify: true, opensDrawer: true, cardCta: 'Angebot einsehen' },
