...
> = {
  ...
  kva_suggested: { type: 'kva', accent: 'var(--ai)', label: 'Angebot', variant: 'ai', title: () => 'Angebots-Entwurf', primary: 'Angebot einsehen', secondary: null, tertiary: null, reco: () => 'Kiki hat aus dem Anruf einen Angebots-Entwurf erstellt. Jetzt Angebot einsehen und verschicken.', assignable: false, notify: true, opensDrawer: true, cardCta: 'Angebot einsehen' },
