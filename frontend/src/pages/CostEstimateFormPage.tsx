...
export function CostEstimateFormPage() {
  ...
  }), [customerId, inquiryId, type, subject, reference, isBinding, tolerance, validity, positions, introText, closingText, paymentTerms, surcharge, surchargeDesc, discountPct])
