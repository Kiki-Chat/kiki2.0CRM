  ...
  return (
    <div className="space-y-5">
      ...
      <div className={cn('flex items-start gap-3 rounded-xl border border-border bg-alt p-4 text-sm text-muted')}>
        ...
        <span>Für Änderungen am Kontingent oder Tarif wende dich bitte an <a href="mailto:info@kikichat.de" className="font-medium text-green-deep hover:underline">info@kikichat.de</a>. Detaillierte Abrechnungen erscheinen ab dem nächsten Update direkt hier.</span>
      </div>
    </div>
  )
}
